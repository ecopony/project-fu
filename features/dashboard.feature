Feature: User dashboard
  ...
  Scenario: Member viewing existing projects on the dashboard as a logged in user
    Given I am logged in as a user
  ...
  Scenario: Viewer viewing existing projects on the dashboard as a logged in user
    Given I am logged in as a user
    And the following projects exist
    | name |
    | Velofight |
    | Project Huxley |
    And I am a viewer of project "Velofight"
    When I am on the dashboard page
    Then I should see "project-fu"
    And I should see "Velofight"
    And I should not see "Project Huxley"
